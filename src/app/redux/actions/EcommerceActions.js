...
export const getProductList = () => dispatch => {
  http.get('/api/ecommerce/get-product-list').then(res => {
    dispatch({
...
export const getCategoryList = () => dispatch => {
  http.get('/api/ecommerce/get-category-list').then(res => {
    dispatch({
...
export const getRatingList = () => dispatch => {
  http.get('/api/ecommerce/get-rating-list').then(res => {
    dispatch({
...
export const getBrandList = () => dispatch => {
  http.get('/api/ecommerce/get-brand-list').then(res => {
    dispatch({
      type: GET_BRAND_LIST,
      payload: res.data,
    })
...
export const getCartList = uid => dispatch => {
  http.get('/api/ecommerce/get-cart-list', { data: uid }).then(res => {
    dispatch({
      type: GET_CART_LIST,
      payload: res.data,
    })
...
export const addProductToCart = (uid, productId) => dispatch => {
  http.post('/api/ecommerce/add-to-cart', { uid, productId }).then(res => {
