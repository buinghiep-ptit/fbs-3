...
const fileProgressReducer = (state = INITIAL_STATE, action) => {
  switch (action.type) {
    case uploadFileTypes.CLEAR_UPLOADING_FILE:
      return {
        ...state,
        fileProgress: {},
      }

    case uploadFileTypes.SET_INITIAL_FILE:
      return {
        ...state,
        fileInfos: [...action.payload.fileInitial],
      }
    ...
    case uploadFileTypes.SUCCESS_UPLOAD_FILE:
      return {
        ...
        fileInfos: [...state.fileInfos, action.payload.fileInfo],
      }
